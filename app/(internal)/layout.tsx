    ...
    <>
      ...
      <div className={cn("relative flex min-h-dvh flex-col max-w-full mx-auto")}>
        <div className="flex flex-row">
          <aside className="hidden md:sticky md:top-0 md:overflow-hidden md:block md:w-[240px] md:max-w-[240px] md:min-w-[240px] h-screen border-r border-neutral-100 dark:border-neutral-900">
